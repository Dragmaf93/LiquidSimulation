...
int main(int argc, char *argv[])
{
    ...
    unsigned long step=0, maxStep=MAX_STEP;
    ...
    MPI_Type_vector(2,block.nRowsWithNeighbours(),block.nColumnsWithNeighbours(),MPI_FLOAT,&horizontalNeighboursType);
    ...
    if(id == MASTER)
    {
        ...
        blockstype = new MPI_Datatype[numProces];
        for(int i = 0; i < numProces;i++){
            //DEFINE BLOCK TYPE
